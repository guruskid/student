        ...
        <!-- NAVIGATION 
            ...
            <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
              <div class="container-fluid">
                <a class="navbar-brand js-scroll-trigger" href="./"><img src="img/logo.png" style="max-height: 60px;" alt="" class="img-fluid"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                  <ul class="navbar-nav text-uppercase ml-auto">
                    ...
                    <li class="nav-item">
                      <a class="nav-link js-scroll-trigger active" href="testimonials">Testimonials</a>
                    </li>
                    <li class="nav-item">
